using CanineCheckup.Application.Common.Models;
...
using CanineCheckup.Application.TodoItems.Commands.UpdateTodoItem;
using CanineCheckup.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CanineCheckup.Application.TodoItems.Queries.GetTodoItemsWithPagination;

namespace CanineCheckup.Web.Endpoints;
